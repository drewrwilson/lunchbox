...
var logos = {
    'lunchbox': {
        whitePath: '../img/netposi/social-media-icon-white-only-SMALL-700Xx350.png', // path to white logo
        blackPath: '../img/netposi/social-media-icon-black-only-SMALL-700Xx350.png', // path to black logo
        w: 200, // width of logo
